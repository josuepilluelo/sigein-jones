 ...
 * @author jo199
 */
public class consultasyReportesBienesInformaticos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form consultasyReportesBienesInformaticos
     */
    public consultasyReportesBienesInformaticos() {
        initComponents();
        ...
        tipo_consulta_pdf = 1;
        titulo = "Bienes Informaticos Funcionales";
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select "
                    ...
                    + "WHERE b.estatus = 'FUNCIONA' AND tipo_info_mueble = 'INFORMATICO' "
            ...
            modelo_tabla.addColumn("No Inventario");    //0
            modelo_tabla.addColumn("Descripcion");      //1
            modelo_tabla.addColumn("Marca");            //2
            modelo_tabla.addColumn("Estado Actual");    //3
            modelo_tabla.addColumn("Valor");            //4
            modelo_tabla.addColumn("No. Serie");        //5
            modelo_tabla.addColumn("Estatus");          //6
            modelo_tabla.addColumn("Tipo");             //7
            modelo_tabla.addColumn("Tipo");             //8
            modelo_tabla.addColumn("Resguardatario");   //9
            modelo_tabla.addColumn("Ultima Modificacion");//10
    ...
    private void initComponents() {
        ...
        setTitle("Consultas y Reportes Bienes Informaticos");
        ...
        barra_tipos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Funciona", "No Funciona", "Transferidos", "SICOPA", "SARECO" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(barra_busqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(2, 2, 2)
    ...
    private void boton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst1 = cn1.prepareStatement("select "
                    ...
                    + "from bienes b JOIN empleados e "
                    + "ON (b.id_empleado = e.id_empleado) "
                    + "where descripcion_bien like '%" + barra_busqueda.getText().trim() + "%' AND b.estatus = 'FUNCIONA' AND tipo_info_mueble = 'INFORMATICO' "
                    + "ORDER BY b.no_inventario");
            ResultSet rs1 = pst1.executeQuery();
            tabla = new JTable(modelo_tabla);
            //para no poder mover las columnas
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (tipo_consulta_pdf == 1) {
            consulta = "select b.no_inventario, b.descripcion_bien, b.marca, b.estado_actual, concat('$  ',valor_estimado), b.no_serie, b.estatus, b.tipo_sico_sareco, e.nombre_empleado from bienes b JOIN empleados e ON (b.id_empleado = e.id_empleado) WHERE b.estatus = 'FUNCIONA' AND tipo_info_mueble = 'INFORMATICO' ORDER BY b.no_inventario";
        } else if (tipo_consulta_pdf == 2) {
            consulta = "select b.no_inventario, b.descripcion_bien, b.marca, b.estado_actual, concat('$  ',valor_estimado), b.no_serie, b.estatus, b.tipo_sico_sareco, e.nombre_empleado from bienes b JOIN empleados e ON (b.id_empleado = e.id_empleado) WHERE b.estatus = 'NO FUNCIONA' AND tipo_info_mueble = 'INFORMATICO' ORDER BY b.no_inventario";
        } else if (tipo_consulta_pdf == 3) {
            consulta = "select b.no_inventario, b.descripcion_bien, b.marca, b.estado_actual, concat('$  ',valor_estimado), b.no_serie, b.estatus, b.tipo_sico_sareco, e.nombre_empleado from bienes b JOIN empleados e ON (b.id_empleado = e.id_empleado) WHERE b.estatus = 'TRANSFERIDO' AND tipo_info_mueble = 'INFORMATICO' ORDER BY b.no_inventario";
        } else if (tipo_consulta_pdf == 4) {
            consulta = "select b.no_inventario, b.descripcion_bien, b.marca, b.estado_actual, concat('$  ',valor_estimado), b.no_serie, b.estatus, b.tipo_sico_sareco, e.nombre_empleado from bienes b JOIN empleados e ON (b.id_empleado = e.id_empleado) WHERE b.tipo_sico_sareco = 'SICOPA' AND b.estatus = 'FUNCIONA' AND tipo_info_mueble = 'INFORMATICO' ORDER BY b.no_inventario";
        } else if (tipo_consulta_pdf == 5) {
            consulta = "select b.no_inventario, b.descripcion_bien, b.marca, b.estado_actual, concat('$  ',valor_estimado), b.no_serie, b.estatus, b.tipo_sico_sareco, e.nombre_empleado from bienes b JOIN empleados e ON (b.id_empleado = e.id_empleado) WHERE b.tipo_sico_sareco = 'SARECO' AND b.estatus = 'FUNCIONA' AND tipo_info_mueble = 'INFORMATICO' ORDER BY b.no_inventario";
        } else {
        ...
        if (Opcion == JFileChooser.APPROVE_OPTION) {
            ...
            float[] margenCeldas = new float[]{10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f, 10f};//este arreglo sirve para las medidas que tengran cada una de las columnas si son 10 columnas son 1o numero
            ...
            try {
                ...
                PdfPCell cell_5 = new PdfPCell(new Phrase("No. Serie"));
                ...
                tabla.setWidths(margenCeldas);//aqui va el arreglo            
                PdfPCell cell_6 = new PdfPCell(new Phrase("Estaus"));//aqui podrimos modificar las celdas
                ...
                PdfPCell cell_8 = new PdfPCell(new Phrase("Resguardatario"));
    ...
    private void boton_buscar_tiposActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscar_tiposActionPerformed
        ...
        if (var_tipos == 0) {
            ...
            tipo_consulta_pdf = 2;
            titulo = "Bienes Informaticos No Funcionales";
            consulta = ("select "
                    + "b.no_inventario, "
                    + "b.descripcion_bien, "
                    + "b.marca, "
                    ...
                    + "from bienes b JOIN empleados e "
                    + "ON (b.id_empleado = e.id_empleado) "
                    + "WHERE b.estatus = 'NO FUNCIONA' AND tipo_info_mueble = 'INFORMATICO'");
        } else if (var_tipos == 2) {
            tipo_consulta_pdf = 3;
            titulo = "Bienes Informaticos Transferidos";
            consulta = ("select "
                    + "b.no_inventario, "
                    + "b.descripcion_bien, "
                    + "b.marca, "
                    ...
                    + "from bienes b JOIN empleados e "
                    + "ON (b.id_empleado = e.id_empleado) "
                    + "WHERE  b.estatus = 'TRANSFERIDO' AND tipo_info_mueble = 'INFORMATICO'");
        } else if (var_tipos == 3) {
            tipo_consulta_pdf = 4;
            titulo = "Bienes Informaticos Funcionales SICOPA";
            consulta = ("select "
                    + "b.no_inventario, "
                    + "b.descripcion_bien, "
                    + "b.marca, "
                    ...
                    + "from bienes b JOIN empleados e "
                    + "ON (b.id_empleado = e.id_empleado) "
                    + "WHERE b.tipo_sico_sareco = 'SICOPA' AND b.estatus = 'FUNCIONA' AND tipo_info_mueble = 'INFORMATICO'");
        } else if (var_tipos == 4) {
            tipo_consulta_pdf = 5;
            titulo = "Bienes Informaticos Funcionales SARECO";
            consulta = ("select "
                    + "b.no_inventario, "
                    + "b.descripcion_bien, "
                    + "b.marca, "
                    ...
                    + "from bienes b JOIN empleados e "
                    + "ON (b.id_empleado = e.id_empleado) "
                    + "WHERE b.tipo_sico_sareco = 'SARECO' AND b.estatus = 'FUNCIONA' AND tipo_info_mueble = 'INFORMATICO'");
        }
        // TODO add your handling code here:
        // TODO add your handling code here:
        modelo_tabla.setRowCount(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultasyReportesBienesInformaticos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(consultasyReportesBienesInformaticos.class.getName()).log(Level.SEVERE, null, ex);
                }
                new consultasyReportesBienesInformaticos().setVisible(true);
            }
        });
    }
