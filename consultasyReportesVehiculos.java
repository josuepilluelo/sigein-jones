 ...
 * @author jo199
 */
public class consultasyReportesVehiculos extends javax.swing.JFrame {
    ...
    public consultasyReportesVehiculos() {
        initComponents();
        //cerrar();
        ...
        try {
            ...
            tabla.getColumnModel().getColumn(0).setPreferredWidth(200);//No Inventario
            tabla.getColumnModel().getColumn(1).setPreferredWidth(200);//Marca
            tabla.getColumnModel().getColumn(2).setPreferredWidth(200);//Modelo
            tabla.getColumnModel().getColumn(3).setPreferredWidth(250);//Kilometraje
            tabla.getColumnModel().getColumn(4).setPreferredWidth(200);//No. Motor
            tabla.getColumnModel().getColumn(5).setPreferredWidth(150);//Placas
            tabla.getColumnModel().getColumn(6).setPreferredWidth(200);//No. Cilindros
            tabla.getColumnModel().getColumn(7).setPreferredWidth(200);//Tipo
            tabla.getColumnModel().getColumn(8).setPreferredWidth(100);//Tarjeta
            tabla.getColumnModel().getColumn(9).setPreferredWidth(250);//Responsable
            tabla.getColumnModel().getColumn(10).setPreferredWidth(200);//Descripcion
            tabla.getColumnModel().getColumn(11).setPreferredWidth(100);//Estado
            tabla.getColumnModel().getColumn(12).setPreferredWidth(150);//Ultima Modificacion            
    ...
    private void initComponents() {
        ...
        setTitle("Consultas y reportes de vehiculos");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(barra_busqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(6, 6, 6)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultasyReportesVehiculos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(consultasyReportesVehiculos.class.getName()).log(Level.SEVERE, null, ex);
                }
                new consultasyReportesVehiculos().setVisible(true);
            }
        });
    }
