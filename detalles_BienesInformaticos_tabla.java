 ...
 * @author jo199
 */
public class detalles_BienesInformaticos_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form detalles_BienesInformaticos_tabla
     */
    public detalles_BienesInformaticos_tabla() {
        initComponents();
        //cerrar();
        ...
        try {
            ...
            modelo_tabla.addColumn("No. Serie");
    ...
    private void initComponents() {
        ...
        setTitle("Detalles Bienes Informaticos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detalles_BienesInformaticos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new detalles_BienesInformaticos_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    detalles_BienesInformaticos_datos inf = new detalles_BienesInformaticos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
