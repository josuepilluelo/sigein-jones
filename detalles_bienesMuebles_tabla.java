 ...
 * @author jo199
 */
public class detalles_bienesMuebles_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form dateller_bienesMuebles
     */
    public detalles_bienesMuebles_tabla() {
        initComponents();
        //cerrar();
    ...
    private void initComponents() {
        ...
        setTitle("Detalles Bienes Muebles");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addComponent(barra_busqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detalles_bienesMuebles_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new detalles_bienesMuebles_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    detalles_bienesMuebles_datos inf = new detalles_bienesMuebles_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
