 ...
 * @author jo199
 */
public class consultasyReportesEmpleados_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form consultasyReportesEmpleados
     */
    public consultasyReportesEmpleados_tabla() {
        initComponents();
...
//            tabla.addCell("Ubi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultasyReportesEmpleados_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(consultasyReportesEmpleados_tabla.class.getName()).log(Level.SEVERE, null, ex);
                }
                new consultasyReportesEmpleados_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    consultasyReportesEmpleados_datos inf = new consultasyReportesEmpleados_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
