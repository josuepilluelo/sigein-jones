 ...
 * @author jo199
 */
public class bajasVehiculos_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form bajaVehiculos_tabla
     */
    public bajasVehiculos_tabla() {
        initComponents();
        //cerrar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajasVehiculos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(bajasVehiculos_tabla.class.getName()).log(Level.SEVERE, null, ex);
                }
                new bajasVehiculos_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    bajasVehiculos_datos inf = new bajasVehiculos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
