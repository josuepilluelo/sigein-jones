 ...
 * @author crysi
 */
public class asignacionBienesInformaticosTabla extends javax.swing.JFrame {

    /**
     * Creates new form asignacionBienesInformaticosTabla
     */
    public asignacionBienesInformaticosTabla() {
        initComponents();
    ...
    public void mostrarBienes() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select id_bien, no_inventario, descripcion_bien, marca, estado_actual, valor_estimado, tipo_sico_sareco from bienes where id_empleado = (select id_empleado from empleados where nombre_empleado = 'Almacen') and upper(estatus) = 'FUNCIONA' and tipo_info_mueble='INFORMATICO'");
    ...
    private void initComponents() {
        ...
        setTitle("Asignacion de Bienes Informaticos");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(barra_busqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
    ...
    private void boton_asignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_asignarActionPerformed
        ...
        if (selection == (-1)) {
            ...
            if (!id.equals("")) {
                ...
                asignacionBienesInformaticos abm = new asignacionBienesInformaticos();
                abm.setVisible(true);
                dispose();
            }
        }
    ...
    private void boton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst1 = cn1.prepareStatement("select id_bien, no_inventario, descripcion_bien, tipo_sico_sareco, valor_estimado, nombre_empleado, b.estatus from bienes b join empleados e where b.id_empleado = e.id_empleado and tipo_info_mueble='INFORMATICO' and upper(b.estatus)='FUNCIONA' and (b.no_inventario like '" + busqueda + "%');");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(asignacionBienesInformaticosTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new asignacionBienesInformaticosTabla().setVisible(true);
            }
        });
    }
