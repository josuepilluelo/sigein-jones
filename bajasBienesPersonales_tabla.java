 ...
 * @author jo199
 */
public class bajasBienesPersonales_tabla extends javax.swing.JFrame {

    private int tipo_consulta = 0;
    private String titulo = "";
    public static int id_empleado = 0, id_bien=0;
    ...
    /**
     * Creates new form bajasBienesPersonales
     */
    public bajasBienesPersonales_tabla() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajasBienesPersonales_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bajasBienesPersonales_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    bajasBienesPersonales_datos inf = new bajasBienesPersonales_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
