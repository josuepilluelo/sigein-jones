 ...
 * @author jo199
 */
public class bajasBienesMuebles_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form bajasBienesMueblesInformaticos
     */
    public bajasBienesMuebles_tabla() {
        initComponents();
        //cerrar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajasBienesMuebles_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new bajasBienesMuebles_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    bajasBienesMuebles_datos inf = new bajasBienesMuebles_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
