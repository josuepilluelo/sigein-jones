 ...
 * @author jo199
 */
public class borrarBienesInformaticos_tabla extends javax.swing.JFrame {
     ...
     */
    public borrarBienesInformaticos_tabla() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Borrar Bienes Informaticos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(borrarBienesInformaticos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new borrarBienesInformaticos_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    borrarBienesInformaticos_datos inf = new borrarBienesInformaticos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
