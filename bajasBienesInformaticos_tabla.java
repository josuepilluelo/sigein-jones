 ...
 * @author jo199
 */
public class bajasBienesInformaticos_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form bajasBienesInformaticos_tabla
     */
    public bajasBienesInformaticos_tabla() {
        initComponents();
        //cerrar();
    ...
    private void initComponents() {
        ...
        setTitle("Baja Bienes Informaticos");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(barra_busqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(6, 6, 6)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajasBienesInformaticos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(bajasBienesInformaticos_tabla.class.getName()).log(Level.SEVERE, null, ex);
                }
                new bajasBienesInformaticos_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    bajasBienesInformaticos_datos inf = new bajasBienesInformaticos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
